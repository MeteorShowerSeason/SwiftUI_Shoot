...
//    open var loadingDescription     = crBundle?.localizedString(key: "CRRefreshFooterRefreshingText")
    open var loadingMoreDescription = crBundle?.localizedString(key: "上拉加载更多")
    open var noMoreDataDescription  = crBundle?.localizedString(key: "没有更多数据")
    open var loadingDescription     = crBundle?.localizedString(key: "正在加载更多的数据...")
